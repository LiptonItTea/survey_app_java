...
//    @Override
    public List<QuestionAnswer> readEntities(SearchCondition<QuestionAnswer> condition) {
...
//    @Override
    public List<Long> deleteEntities(SearchCondition<QuestionAnswer> condition) {
